...
if (isset($_POST['login_btn'])) {
    ...
    if (empty($emp_no)) {
        ...
        // MySQL
        $check = "SELECT emp_no, full_name, dept, section, line_no, role FROM m_hr_accounts WHERE BINARY emp_no = '$emp_no'";
        // MS SQL Server
        // $check = "SELECT emp_no, full_name, dept, section, line_no, role FROM m_hr_accounts WHERE emp_no = '$emp_no' COLLATE SQL_Latin1_General_CP1_CS_AS";
