...
if (isset($_POST['login_btn'])) {
    ...
    if (empty($emp_no)) {
        ...
        // MS SQL Server
        $query = "SELECT emp_no, full_name, dept, section, line_no, role 
                FROM m_hr_accounts WHERE emp_no = ? COLLATE SQL_Latin1_General_CP1_CS_AS AND role = 'ga'";
