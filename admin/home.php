    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card card-gray-dark card-outline">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-clock"></i> Time In and Out - Shift Group ADS</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                  <i class="fas fa-minus"></i>
                </button>
            ...
            <div class="card-body">
              <div class="row mb-2">
                <div class="col-sm-4">
                  <span id="day_view_ads"></span>
                </div>
                <div class="col-sm-2 offset-sm-6">
                  <span id="count_view_ads"></span>
                </div>
              </div>
              <div class="table-responsive" style="max-height: 500px; overflow: auto; display:inline-block;">
                <table id="recentTimeInOutNsTable" class="table table-sm table-head-fixed text-nowrap table-hover">
                  ...
                  <tbody id="recentTimeInOutAdsData" style="text-align: center;">
                    <tr>
                      <td colspan="7" style="text-align:center;">
                        <div class="spinner-border text-dark" role="status">
                          <span class="sr-only">Loading...</span>
