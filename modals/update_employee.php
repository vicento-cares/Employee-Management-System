...
$disabled = isset($_SESSION['emp_no_hr']) ? 'disabled' : '';
$disabled_tc = isset($_SESSION['emp_no_tc']) ? 'disabled' : '';
if (empty($disabled) && empty($disabled_tc)) {
  $disabled = 'disabled';
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-3">
            ...
            <select id="skill_level_master_update" class="form-control" style="height:45px; border: 1px solid black;" disabled>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <select id="emp_js_s_master_update" class="form-control" style="height:45px; border: 1px solid black;" <?= $disabled_tc ?>></select>
          </div>
          <div class="col-6">
            <label>Supervisor:</label>
            <select id="emp_sv_master_update" class="form-control" style="height:45px; border: 1px solid black;" <?= $disabled_tc ?>></select>
          </div>
        </div>
        <div class="row">
          <div class="col-6">
            <label>Managing/Approving Officer:</label>
            <select id="emp_approver_master_update" class="form-control" style="height:45px; border: 1px solid black;" <?= $disabled_tc ?>></select>
          </div>
          <div class="col-6">
            <label class="mb-3">Resigned</label>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="resigned_master_update" <?= $disabled_tc ?>>
