...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Access Locations (EmpMgtSys | Admin)</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home.php">Home</a></li>
            <li class="breadcrumb-item active">Access Locations</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-gray-dark card-outline">
            ...
            <div class="card-body">
              <div class="row mb-4">
                ...
                <div class="col-sm-3">
                  <label>IP</label>
                  <input type="text" class="form-control" id="ip_search" placeholder="Search" autocomplete="off" maxlength="255">
                </div>
                <div class="col-sm-3">
                  <label>&nbsp;</label>
