			...
			$.ajax({
				...
				success: response => {
					...
					var options = {
						...
						title: {
							text: `Top 10 Section for Compliance Time In Percentage`,
							align: 'left'
						}
					};
			...
			$.ajax({
				...
				success: response => {
					...
					var options = {
						...
						title: {
							text: `Top 10 Section for Non-Compliance Time In Percentage`,
							align: 'left'
						}
					};
			...
			$.ajax({
				...
				success: response => {
					...
					var options = {
						...
						title: {
							text: 'Compliance Percentage Time Out Per Section Trend',
							align: 'left'
						},
						stroke: {
							curve: 'smooth'
			...
			$.ajax({
				...
				success: response => {
					...
					var options = {
						...
						title: {
							text: 'Non-Compliance Percentage Time Out Per Section Trend',
							align: 'left'
						},
						stroke: {
							curve: 'smooth'
			...
			$.ajax({
				...
				success: response => {
					...
					var options = {
						...
						title: {
							text: `Top 10 Section for Compliance Time Out Percentage`,
							align: 'left'
						}
					};
			...
			$.ajax({
				...
				success: response => {
					...
					var options = {
						...
						title: {
							text: `Top 10 Section for Non-Compliance Time Out Percentage`,
							align: 'left'
						}
					};
