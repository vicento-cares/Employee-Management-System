...
<script type="text/javascript">
    ...
    const export_absences_template = () => {
        ...
        window.open('../process/export/exp_absences_template.php?day=' + day + "&shift_group=" + shift_group + "&dept=" + dept + "&section=" + section + "&line_no=" + line_no + "&attendance_status=" + attendance_status, '_blank');
    }
