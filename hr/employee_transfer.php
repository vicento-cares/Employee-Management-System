            ...
            <div class="card-body">
              <div class="tab-content" id="et-tabContent">
                ...
                <div class="tab-pane fade show active" id="et-1" role="tabpanel" aria-labelledby="et-1-tab">
                    ...
                    <div class="col-10">
                      <div class="row mb-2">
                        ...
                        <div class="col-sm-2">
                          ...
                          <select id="et_dept_from_search" class="form-control" onchange="get_ongoing_employee_transfer()"></select>
                        </div>
                        <div class="col-sm-2">
                          <label>Section From:</label>
                          <select id="et_section_from_search" class="form-control" onchange="get_ongoing_employee_transfer()"></select>
                        </div>
                        <div class="col-sm-2">
                  ...
                  <div class="row mb-2">
                    <div class="col-sm-6 col-lg-4 p-1 border bg-secondary"><center>Not Yet Approve</center></div>
                    <div class="col-sm-6 col-lg-4 p-1 border bg-danger"><center>Date Effectivity Overdue</center></div>
                    <div class="col-sm-6 col-lg-4 p-1 border"><center>Ongoing Approval</center></div>
                  </div>
                  <div class="row mb-2">
                    <div class="col-sm-2">
