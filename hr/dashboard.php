        ...
        <div class="col-sm-12">
          <div class="card card-gray-dark card-outline">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-chart-bar mr-2"></i>Overall Dashboard as of <?= date('F j, Y') ?>
              </h3>
            ...
            <div class="card-body">
              <div class="row mb-4">
                ...
                <div class="col-sm-2 offset-sm-2">
                  <label>&nbsp;</label>
                  <button type="button" class="btn bg-gray-dark btn-block" onclick="count_od()"><i
              ...
              <div class="row">
                ...
                <div class="col-8" id="daily_absent_rate_chart"
              ...
              <div class="row" id="daily_absent_rate_provider_chart"
                style="display: flex; justify-content: center; align-items: center; height: 100%;">
                <div class="spinner-border text-dark" role="status">
                  <span class="sr-only">Loading...</span>
                </div>
          ...
          <div class="card card-gray-dark card-outline">
            ...
            <div class="card-body">
              <div class="row mb-4">
                ...
                <div class="col-sm-2">
                  <label>&nbsp;</label>
                  <button type="button" class="btn bg-gray-dark btn-block" onclick="count_emp_dashboard()"><i
                      class="fas fa-search"></i> Search</button>
                </div>
                <div class="col-sm-2">
                  <label>&nbsp;</label>
                  <button type="button" class="btn bg-success btn-block" onclick="export_dashboard()"><i
                  ...
                  <div class="card card-gray-dark card-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" id="dashboards-tab" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" id="dashboards-1-tab" data-toggle="pill" href="#dashboards-1"
                            role="tab" aria-controls="dashboards-1" aria-selected="true">Shift Group A</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="dashboards-2-tab" data-toggle="pill" href="#dashboards-2" role="tab"
                            aria-controls="dashboards-2" aria-selected="false">Shift Group B</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="dashboards-3-tab" data-toggle="pill" href="#dashboards-3" role="tab"
                            aria-controls="dashboards-3" aria-selected="false">Shift Group ADS</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body">
