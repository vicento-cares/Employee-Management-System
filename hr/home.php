    ...
    <div class="row">
            ...
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-sm-3">
                  ...
                  <input type="date" class="form-control" id="pending_leave_date_search" value="<?=date('Y-m-d')?>">
                </div>
                <div class="col-sm-3">
                  <label>Leave Type</label>
                  <select class="form-control" id="pending_leave_type_search" style="width: 100%;" required>
                ...
                <div class="col-sm-3 offset-sm-3">
                  <label>&nbsp;</label>
                  <button type="button" class="btn bg-gray-dark btn-block" onclick="get_pending_leave_forms()"><i class="fas fa-search"></i> Search</button>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card card-gray-dark card-outline">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-history"></i> Leave Form History Table</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                  <i class="fas fa-minus"></i>
                </button>
