                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input class="form-control" type="date" placeholder="Select date..."
                                        ...
                                        id="date_authorized_search">
                                </div>
                                <div class="col-sm-2">
                                    <label for="">Expire Date</label>
                                    <input class="form-control" type="date" placeholder="Select date..."
                                        onfocus="(this.type='date')" onblur="(this.type='text')"
                                        id="expire_date_search">
                                </div>
                            </div>
                            <br>
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-1">
                                    <label>&nbsp;</label>
                                    <!-- search button -->
                                    <button class="btn btn-block btn-success d-flex justify-content-left"
                                        id="search_btn" onclick="search_data(1)"
                                ...
                                <div class="col-sm-1">
                                    <label>&nbsp;</label>
                                    <!-- exportt button -->
                                    <a class="btn btn-block btn-secondary d-flex justify-content-left"
                                        onclick="export_data()"
                            ...
                            <div class="col-12">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12 col-md-9 col-9">
                                        <div class="dataTables_info" id="count_rows_display" role="status"
                                    ...
                                    <div class="col-sm-12 col-md-1 col-1">
                                        <input list="process_details_paginations" class="form-control"
                                            id="process_details_pagination" maxlength="255">
...
include 'plugins/js/certification_script.php';
?>