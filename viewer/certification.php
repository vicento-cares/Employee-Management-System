                            ...
                            <div class="card card-gray-dark card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-1">
                                        ...
                                        <select class="form-control btn bg-success" required name="category" id="category" onchange="search_data(1)">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control btn" name="pro" required id="pro" style="width: 100%; border: 2px solid black;background-color: white;color: black;font-size: 16px;cursor: pointer; border-color: var(--success);" >
