...
include 'plugins/navbar/dashboard_navbar.php';
?>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-2">
                            <label>Section</label>
                            <input type="text" class="form-control" id="section_master_search" placeholder="Search"
                                autocomplete="off" maxlength="255">
                        </div>
                        <div class="col-sm-2">
                            <label>Line No.</label>
                            <input type="text" class="form-control" id="line_no_master_search" placeholder="Search"
                                autocomplete="off" maxlength="255">
                        </div>
                            ...
                            <div class="card card-gray-dark card-tabs">
                                <div class="card-header p-0 border-bottom-0">
                                    <ul class="nav nav-tabs" id="dashboards-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="dashboards-2-tab" data-toggle="pill" href="#dashboards-2"
                                                role="tab" aria-controls="dashboards-2" aria-selected="false">Shift Group B</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="dashboards-3-tab" data-toggle="pill" href="#dashboards-3"
                                                role="tab" aria-controls="dashboards-3" aria-selected="false">Shift Group
                                                ADS</a>
                                        </li>
                                    </ul>
                                </div>
