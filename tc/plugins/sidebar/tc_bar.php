<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="home.php" class="brand-link">
    ...
    <span class="brand-text font-weight-light">EmpMgtSys | TC</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/emp_mgt/tc/home.php") { ?>
        ...
        <li class="nav-item d-none">
          <?php if ($_SERVER['REQUEST_URI'] == "/emp_mgt/tc/dashboard.php") { ?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/emp_mgt/tc/employees.php") { ?>
        ...
        <li class="nav-item d-none">
          <?php if ($_SERVER['REQUEST_URI'] == "/emp_mgt/tc/attendances.php") { ?>
        ...
        <li class="nav-item d-none">
          <?php if ($_SERVER['REQUEST_URI'] == "/emp_mgt/tc/individual_attendances.php") { ?>
