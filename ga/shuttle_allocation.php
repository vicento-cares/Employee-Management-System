...
<?php include 'plugins/sidebar/ga_bar.php';?>

<?php
// For Date and Shift Display
...
if ($server_time >= '00:00:00' && $server_time < '06:00:00') {
  $server_date_only_f = date('F j, Y',(strtotime('-1 day',strtotime($server_date_only))));
} else {
  $server_date_only_f = date('F j, Y');
}
?>
              ...
              <div class="tab-content" id="sa-tabContent">
                <div class="tab-pane fade show active" id="sa-1" role="tabpanel" aria-labelledby="sa-1-tab">
                    ...
                    <div class="col-sm-12">
                      <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                          <h3 class="card-title"><i class="fas fa-file-alt"></i> Shuttle Allocation Per Section Route as of <?=$server_date_only_f?> <?=get_shift($server_time)?></h3>
                        ...
                        <div class="card-body">
                          <div class="table-responsive" style="max-height: 500px; overflow: auto; display:inline-block;">
                            <table id="shuttleAllocationPerSectionRoute" class="table table-sm table-head-fixed text-nowrap">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                          <h3 class="card-title"><i class="fas fa-file-alt"></i> Shuttle Allocation Per Section as of <?=$server_date_only_f?> <?=get_shift($server_time)?></h3>
                          <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                              <i class="fas fa-minus"></i>
                            </button>
                        ...
                        <div class="card-body">
                          <div class="table-responsive" style="max-height: 500px; overflow: auto; display:inline-block;">
                            <table id="shuttleAllocationPerSection" class="table table-sm table-head-fixed text-nowrap">
                              <thead style="text-align: center;">
                                <tr>
                                  <th>Section</th>
                                  <th>TOTAL MP OUT</th>
                ...
                <div class="tab-pane fade" id="sa-2" role="tabpanel" aria-labelledby="sa-2-tab">
                  <div class="row mb-2">
                    ...
                    <div class="col-sm-2">
                      ...
                      <select class="form-control" id="shuttle_allocation_shift_group" style="width: 100%;">
                    ...
                    <div class="col-sm-2">
                      <label>&nbsp;</label>
                      <button type="button" class="btn bg-gray-dark btn-block" onclick="get_shuttle_allocation()"><i class="fas fa-search"></i> Search</button>
                    </div>
                  </div>
                  <div class="row mb-2">
                    <div class="col-sm-2">
                      <label>Department:</label>
                      <select id="shuttle_allocation_dept" class="form-control"></select>
                    </div>
                    <div class="col-sm-4">
                      <label>Section:</label>
                      <select id="shuttle_allocation_section" class="form-control"></select>
                    </div>
                    <div class="col-sm-4">
                      <label>Line No:</label>
                      <select id="shuttle_allocation_line_no" class="form-control"></select>
                    </div>
                    <div class="col-sm-2">
                      <label>&nbsp;</label>
                  ...
                  <div class="row mb-4">
                    <div class="col-sm-1">
                      <label>&nbsp;</label>
                      <button type="button" class="btn bg-success btn-block" id="btnOut5" onclick="verify_set_out(5)" disabled>OUT 3 😁</button>
                    </div>
                    <div class="col-sm-1">
                      <label>&nbsp;</label>
                      <button type="button" class="btn bg-info btn-block" id="btnOut6" onclick="verify_set_out(6)" disabled>OUT 4 😑</button>
                    </div>
                    <div class="col-sm-1">
                      <label>&nbsp;</label>
                      <button type="button" class="btn bg-danger btn-block" id="btnOut7" onclick="verify_set_out(7)" disabled>OUT 5 😠</button>
                    </div>
                    <div class="col-sm-1">
                      <label>&nbsp;</label>
                      <button type="button" class="btn bg-purple btn-block" id="btnOut8" onclick="verify_set_out(8)" disabled>OUT 6 👻</button>
                    </div>
                  ...
                  <div class="table-responsive" style="max-height: 500px; overflow: auto; display:inline-block;">
                    <table id="shuttleAllocationTable" class="table table-sm table-head-fixed text-nowrap table-hover">
                      ...
                      <tbody id="shuttleAllocationData" style="text-align: center;"></tbody>
                    </table>
                  </div>
                  <div class="row mt-2">
                    <div class="col-sm-12">
                        ...
                        <div class="card-body">
                          ...
                          <div class="table-responsive" style="max-height: 500px; overflow: auto; display:inline-block;">
                            <table id="shuttleAllocationPerRouteTable" class="table table-sm table-head-fixed text-nowrap">
                              ...
                              <tbody id="shuttleAllocationPerRouteData" style="text-align: center;"></tbody>
                            </table>
                          </div>
                        </div>
                        <!-- /.card-body -->
                ...
                <div class="tab-pane fade" id="sa-3" role="tabpanel" aria-labelledby="sa-3-tab">
                  ...
                  <div class="row mb-4">
                    <div class="col-sm-2">
                      <label>Dept:</label>
                      <select id="sa_dept_search" class="form-control"></select>
                    </div>
                    <div class="col-sm-4">
                      <label>Section:</label>
                      <select id="sa_section_search" class="form-control"></select>
                    </div>
                    <div class="col-sm-4">
                      <label>Line No:</label>
                      <select id="sa_line_no_search" class="form-control"></select>
                    </div>
                    <div class="col-sm-2">
                      <label>&nbsp;</label>
