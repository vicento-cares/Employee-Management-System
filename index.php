...
<head>
    ...
    <title>EmpMgtSys | Homepage</title>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                            <li><a href="/emp_mgt/wi/Employee Management System Work Instruction rev. 4(Production).xlsx?v=<?php echo time(); ?>" target="_blank" class="dropdown-item">EmpMgtSys Production WI</a></li>
                            ...
                            <li><a href="/emp_mgt/wi/Employee Management System Work Instruction rev. 3(Control Area).xlsx?v=<?php echo time(); ?>" target="_blank" class="dropdown-item">EmpMgtSys Control Area WI</a></li>
                            <li><a href="/emp_mgt/wi/Employee Management System Work Instruction rev. 1(GA).xlsx?v=<?php echo time(); ?>" target="_blank" class="dropdown-item">EmpMgtSys GA WI</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow">
                            ...
                            <li><a href="/emp_mgt/ga/" target="_blank" class="dropdown-item">EmpMgtSys GA Login</a></li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="row d-flex no-block justify-content-center align-items-center vh-100">
                    <img class="animation__wobble img-circle elevation-3 p-1 bg-white" src="dist/img/logo.webp" alt="Logo" height="240" width="240">
                    <h1 class="ml-5"><b>Employee Management System</b></h1>
                </div>
            </div>
            <!-- /.content -->
        </div>
