  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row mb-4">
        ...
        <div class="col-sm-2">
          <a class="btn btn-dark btn-block" href="../template/employee_transfer_template.csv?v=<?php echo time(); ?>"><i class="fas fa-download"></i> Download Template</a>
        </div>
        <div class="col-sm-2">
                    ...
                    <div class="row">
                      <div class="col-10">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <label>Employee No:</label>
                            <input type="text" class="form-control" id="eth_emp_no_search" name='emp_no' placeholder="Search" autocomplete="off" maxlength="255">
                          </div>
                          <div class="col-sm-2">
                            <label>Position:</label>
